...
- UI-страница AI policy center (`/ui/ai/policies`) с CRUD-потоком policy, dry-run предпросмотром, фильтрами policy-audit, quick-links в JSON/CSV audit и UI-пагинацией (prev/next по offset).
